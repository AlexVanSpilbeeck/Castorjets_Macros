...
public:
	...
	void makeRadiusHistos(TString inputdir, TString regexpstr, bool isData, const char* outputname);	
        ...
        void makeJetHistos_radii_strippedTree(TString inputdir, bool isData, const char* outputname, int totalEvents, TString date, TString filename, TString jettype, double threshold, TString setup, double deltaphimax, double etawidth, TString match);
