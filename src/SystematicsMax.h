#ifndef SystematicsMax_h
#define SystematicsMax_h
...
class SystematicsMax {
public:
	SystematicsMax(TString inputdir, TObjArray* filelist, bool isData, const char* outputname);
	virtual ~SystematicsMax();
	...
	// static functions
	static void* OpenROOTFile(SystematicsMax* arg);
