#ifndef SystematicsMin_h
#define SystematicsMin_h
...
class SystematicsMin {
public:
	SystematicsMin(TString inputdir, TObjArray* filelist, bool isData, const char* outputname);
	virtual ~SystematicsMin();
	...
	// static functions
	static void* OpenROOTFile(SystematicsMin* arg);
